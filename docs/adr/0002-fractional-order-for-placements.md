...
Yeti lets users reorder edge groups on a rim, links inside groups, pin strip entries, and other sequences. Integer indices make insert-and-push painful and cause write amplification across siblings.
