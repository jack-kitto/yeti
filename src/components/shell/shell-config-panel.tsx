...
export function ShellConfigPanel({ library, workspaceName }: ShellConfigPanelProps) {
  ...
  return (
    <div className="shell-config">
      ...
      <section className="shell-config-section">
        <h2 className="shell-config-heading">Link catalog</h2>
