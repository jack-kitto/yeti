...
export const STARTER_CATALOG: Link[] = [
  ...
  link("yeti-repo", "https://github.com/jack-kitto/yeti", "Yeti repo"),
  link("ci", "https://github.com/features/actions", "GitHub Actions"),
  link("releases", "https://github.com/jack-kitto/yeti/releases", "Releases"),
  ...
  const work = workspace("work", "Work", workTheme, {
    left: [
      ...
      },
      {
        ...
        name: "Yeti",
        handleIcon: "🧊",
        links: ["localhost", "yeti-repo", "cloudflare", "ci", "releases"],
      },
      {
        id: "work-docs",
        name: "Docs",
