...
export const STARTER_CATALOG: Link[] = [
  ...
  link("localhost", "http://localhost:3000/home", "Yeti — Home"),
  link("yeti-repo", "https://github.com/gudlab/quickshell-start", "Yeti repo"),
  link("vercel", "https://vercel.com", "Vercel"),
  link("ci", "https://github.com/features/actions", "GitHub Actions"),
  link("releases", "https://github.com/gudlab/quickshell-start/releases", "Releases"),
  ...
  const work = workspace("work", "Work", workTheme, {
    left: [
      ...
      },
      {
        ...
        name: "Yeti",
        handleIcon: "🧊",
        links: ["localhost", "yeti-repo", "vercel", "ci", "releases"],
      },
      {
        id: "work-docs",
        name: "Docs",
  ...
  const personal = workspace("personal", "Personal", personalTheme, {
    left: [
      ...
      },
      {
        ...
        name: "Side projects",
        handleIcon: "🌙",
        links: ["github", "vercel", "railway", "prisma", "stripe"],
      },
    ],
    top: [],
    bottom: [],
